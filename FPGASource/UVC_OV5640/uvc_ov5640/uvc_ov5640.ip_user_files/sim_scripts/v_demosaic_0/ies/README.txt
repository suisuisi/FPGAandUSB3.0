...
#
# Generated by export_simulation on Wed Nov 17 22:40:30 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './v_demosaic_0.sh' script.

./v_demosaic_0.sh -reset_run
...
./v_demosaic_0.sh -noclean_files

For more information on the script, please type './v_demosaic_0.sh -help'.
