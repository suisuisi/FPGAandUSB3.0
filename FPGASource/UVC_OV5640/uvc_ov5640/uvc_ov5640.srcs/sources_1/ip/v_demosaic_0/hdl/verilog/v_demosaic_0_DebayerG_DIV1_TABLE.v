...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module v_demosaic_0_DebayerG_DIV1_TABLE_rom (
...
initial begin
    $readmemh("./v_demosaic_0_DebayerG_DIV1_TABLE_rom.dat", ram0);
    $readmemh("./v_demosaic_0_DebayerG_DIV1_TABLE_rom.dat", ram1);
end
...
`timescale 1 ns / 1 ps
module v_demosaic_0_DebayerG_DIV1_TABLE(
    reset,
    clk,
    address0,
    ce0,
...
v_demosaic_0_DebayerG_DIV1_TABLE_rom v_demosaic_0_DebayerG_DIV1_TABLE_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
