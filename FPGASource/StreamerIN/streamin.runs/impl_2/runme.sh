...
HD_PWD='C:/Users/Administrator/Desktop/FPGAUSB/CYUSB3014/StreamerIN/streamin/streamin.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log streamin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source streamin.tcl -notrace
