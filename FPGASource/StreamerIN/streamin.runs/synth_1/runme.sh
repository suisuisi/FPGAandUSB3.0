...
HD_PWD='C:/Users/Administrator/Desktop/FPGAUSB/CYUSB3014/StreamerIN/streamin/streamin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log streamin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source streamin.tcl
