...
HD_PWD='C:/Users/Administrator/Desktop/FPGAUSB/CYUSB3014/StreamerOUT/streamout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log streamout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source streamout.tcl -notrace
