...
HD_PWD='C:/Users/Administrator/Desktop/FPGAUSB/CYUSB3014/FPGASource/USBLoopBack/StreamerOUT/streamout/streamout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log streamout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source streamout.tcl
